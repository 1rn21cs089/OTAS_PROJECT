...
switch ($subject_type) {
    case 'Core':
        $sql_students_count = "SELECT count(DISTINCT USN) as STUDENT_COUNT FROM core_subject_response WHERE SubCode = '$subCode' and Section = '$section'";
        break;
    case 'Elective':
        $sql_students_count = "SELECT count(DISTINCT USN) as STUDENT_COUNT FROM elective_response WHERE SubCode = '$subCode' and Section = '$section'";
        break;
    case 'Lab':
        $sql_students_count = "SELECT count(DISTINCT USN) as STUDENT_COUNT FROM lab_response WHERE SubCode = '$subCode' and Section = '$section'";
        break;
    default:
        $student_count = "N/A";
        break;
