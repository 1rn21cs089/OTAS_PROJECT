...
if(isset($_SESSION['username'])){
    ...
    if ($subresult->num_rows > 0) {
        ...
        WHERE (c.Core = 1 OR c.Lab = 1 OR c.Elective = 1)   AND c.Section = '$section' AND c.Sem = $sem AND s.USN LIKE '$usn' 
        ORDER BY c.SubCode" ;
        ...
        if ($result->num_rows > 0) {
            ...
            echo "</table>";
            echo "<form action='instruction.php' method='get'>";
            echo "<button type='submit' class='btn-blue'>PROCEED</button>";
            echo "</form>";

            echo "</table>";
            echo "<form action='detailsverification.php' method='get'>";
