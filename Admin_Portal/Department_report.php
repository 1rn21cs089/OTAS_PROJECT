...
<nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="Subject_Teacher_Report.php">Subject Teacher Report</a>
...
function displayTeacherDetails(teacherDetails) {
    ...
    teacherDetails.forEach(function(teacher) {
        ...
        var reportUrl = 'report.php?sem=' + encodeURIComponent(document.getElementById("Semester").value) + 
                        '&section=' + encodeURIComponent(document.getElementById("Section").value) + 
