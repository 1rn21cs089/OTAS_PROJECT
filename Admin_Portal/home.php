...
<body>
    <header id="custom-header">
            ...
            <nav id="custom-nav" class="custom-nav-di">
                ...
                <div class="dropdown">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        ...
                        <a href="getpassword.php">Get Password</a>
                        <a href="classpassword.php">CLass Passwords</a>
                    </div>
                </div>
                ...
                <div class="dropdown">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        ...
                        <a href="addbatch_students.php">Add Batch(Excel)</a>
                    </div>
                </div>
                <div class="dropdown">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        ...
                        <a href="edit_subject.php">Edit Subject</a>
                        <a href="view_sub_combo.php">Edit Subject Combination</a>
                        <a href="remove_elective.php">Remove Elective</a>
                    </div>
                </div>
                <div class="dropdown">
                    <button onclick="toggleDropdown()" class="dropbtn">View <i class="fa-solid fa-caret-down"></i></button>
                    <div id="myDropdown" class="dropdown-content">
                        <a href="view_sub_combo.php">View Subject Combination</a>
                    </div>
                </div>
                <div class="dropdown">
                <button onclick="toggleDropdown()" class="dropbtn">Complaint<i class="fa-solid fa-caret-down"></i></button>
                    <div id="myDropdown" class="dropdown-content">
        ...
        <a href="labcomp.php">LABORATORY</a>
              ...
              <div class="dropdown">
                <button onclick="toggleDropdown()" class="dropbtn">Reports<i class="fa-solid fa-caret-down"></i></button>
                    <div id="myDropdown" class="dropdown-content">
        <a href="Department_report.php">Department Report</a>
        <a href="Subject_Teacher_Report.php">Subject Teacher Report</a>
        <a href="Absentee_Report.php">Student Absent Report</a>
