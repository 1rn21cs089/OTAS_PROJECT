...
if(isset($_SESSION['username'])){
    ...
    if ($subresult->num_rows > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "</table>";
            echo "<form action='CoreCheck.php' method='get'>";
            echo "<button type='submit' class='btn-blue'>CoreCheck</button>";
            echo "</form>";

            echo "</table>";
            echo "<form action='proceed.html' method='get'>";
            echo "<button type='submit' class='btn1-blue'>Proceed</button>";
            echo "</form>";
        } else {
            echo "0 results";
        }
