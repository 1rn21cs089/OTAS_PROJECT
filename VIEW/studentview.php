...
if (isset($_SESSION['username'])) {
    ...
    $deptQuery = "SELECT DepName FROM department d JOIN student s ON s.Dept_Id = d.DeptId WHERE s.USN = ?";
...
<body id="for_body">
    ...
    <div class="wow fadeIn Page" style="padding:20px;width: 80%;background: rgba(54, 25, 25, 0.4);border-radius: 10px;">
        ...
        <div class="Student-Details">
            ...
            <div class="row">
                <div style="font-family:'Arial Rounded MT';">
                        Department: <?php echo isset($dept) ? $dept : 'Not available'; ?>
                </div>
