    ...
    if ($subresult->num_rows > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr id='edit-row-" . $row["SubCode"] . "' class='edit-input' style='display:none;'><td><input type='text' id='subcode-" . $row["SubCode"] . "' value='" . $row["SubCode"] . "'></td>";
                echo "<td><input type='text' id='subname-" . $row["SubCode"] . "' value='" . $row["SubName"] . "'></td>";
                echo "<td><input type='text' id='teachername-" . $row["SubCode"] . "' value='" . $row["Teacher_FName"] . " " . $row["Teacher_LName"] . "'></td>";
...
<script>
    ...
    function saveEdit(subcode) {
        var newSubcode = document.getElementById('subcode-' + subcode).value;
